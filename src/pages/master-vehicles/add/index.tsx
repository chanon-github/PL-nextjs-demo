...
import type { MasterVehiclesCrudContentProps, MasterVehiclesCrudContainerProps, MasterVehiclesCrudContentForm } from './index.model';

const MasterVehiclesCrudContainer = ( props: MasterVehiclesCrudContainerProps ): ReactElement => {
  /** Hook section */
    ...
    useEffect(() => {
        if(Router.isReady) {
            switch(Router.route){
                case '/master-vehicles/add': {
                    setMode('add'); 
                    break
                };
                case '/master-vehicles/edit/[id]': {
                    setMode('edit'); 
                    antdForm.setFieldsValue({});
                    setIdFromPath();
                    break
                };
                case '/master-vehicles/view/[id]': {
                    setMode('view'); 
                    setIdFromPath();
                    break;
                }
    ...
    const contentProps: MasterVehiclesCrudContentProps = {
        mode,
        onSubmitForm,
        onClickBack
    };
