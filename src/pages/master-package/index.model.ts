...
import { CrtPackage, CrtPackageCrtPackagePagination, PackageApiApiPackageSearchGetRequest, PackageTypeOutputListDataResponse } from "@/services/rental-api/generated";
...
import { AxiosRequestConfig } from "axios";
  ...
  export interface PackageManagementState {
    pageIndex: number;
    pageSize: number;
    useApiPackageGet: ApiResponse<CrtPackageCrtPackagePagination, PackageApiApiPackageSearchGetRequest | undefined>;
