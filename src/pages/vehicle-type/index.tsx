 ...
 */
import type { VehicleTypeContentProps, VehicleTypeContainerProps, FormValues ,FormSearch,GetDataParams} from './index.model';
...
const VehicleTypeListContainer: NextPageWithLayout<VehicleTypeContainerProps> = ( props: VehicleTypeContainerProps ): ReactElement => {
  /** Hook section */
  ...
  useEffect(() => {
    //-- Ex. Set Default Checked Item in Table --//
      //=== setSelectedRowKeysList((prevKeys) => [...prevKeys, '0033']) ===//
      // setSelectedRowKeysList((prevKeys) => [...prevKeys, '0033'])
    //------------------------------------------//
  ...
  const handleCloseModal = () => {
    ...
    const contentProps: VehicleTypeContentProps = {
        page,
        pageSize,
        dataList,
        totalData,
...
const renderOptions = (props: VehicleTypeContentProps): ReactElement => {
  return (
    <>
...
const renderTable = (props: VehicleTypeContentProps): ReactElement => {
...
const renderModalForm = (props: VehicleTypeContentProps): ReactElement => {
              ...
              >
                  <Form form={props.form} layout="vertical" name="modal_form_layout">
                    <Row gutter={[16, 5]}>
                      ...
                      <Form.Item
                          name="typeName"
                          label="ชื่อประเภทรถยนต์"
                          rules={[{ required: true, message: 'กรุณากรอกข้อมูล!' }]}
                        >
                          <Input placeholder="ชื่อประเภทรถยนต์" allowClear />
                        </Form.Item>
                      </Col>
...
export default VehicleTypeListContainer;